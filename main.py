...
@app.put("/produtores_rurais/{produtor_id}")
...
@app.delete("/produtores_rurais/{produtor_id}")
...
@app.get("/produtores_rurais/{produtor_id}")
...
@app.get("/produtores_rurais/total/")
...
@app.get("/produtores_rurais/hectares/")
